...
<form method="POST" action="{{ route('register') }}">
  ...
  <div class="form-group">
    ...
    <input name="password" type="hidden" value="" required class="form-control {{ $errors->has('password') ? 'is-invalid' : null }}">
  ...
  <div class="form-group">
    ...
    <input name="password_confirmation" type="hidden" value="" required class="form-control">
  </div>
